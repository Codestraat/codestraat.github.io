    ...
    return (
      ...
      <div className="row">
         ...
         <div className="nine columns main-col">
            ...
            <p>I am inquisitive and assertive, task-driven with a strong foundational knowledge of modern technology tools, frameworks, and cross-platform designs, with extensive web development and data collections experience, I seek to leverage solid development skills with a focus on collaboration, communication, passion, and creativity.</p>
            <div className="row">
